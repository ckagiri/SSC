...
import { capitalize } from '../utils/helpers'; // const styledBy = (property, mapping) => props => mapping[props[property]];
...
var Typography = function Typography(props) {
  ...
  var align = props.align,
      ...
      other = _objectWithoutProperties(props, ["align", "className", "color", "component", "gutterBottom", "headlineMapping", "inline", "internalDeprecatedVariant", "noWrap", "paragraph", "variant"]); // const variant = getVariant(theme, variantProp);
...
Typography.propTypes = {
   ...
   */
  color: PropTypes.oneOf(['default', 'error', 'inherit', 'primary', 'secondary', 'textPrimary', 'textSecondary', 'info', 'notice', 'low', 'normal', 'medium', 'high', 'extreme']),
